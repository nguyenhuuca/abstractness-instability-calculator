...
class ThresholdEvaluatorTest {
    ...
    void allGatesDisabledAlwaysPasses() {
        ...
        GateResult result = evaluator.evaluate(metrics, GateConfig.disabled());
    ...
    void maxPackageDistanceFlagsOnlyPackagesOverThreshold() {
        ...
        GateConfig cfg = new GateConfig(true, 0.7, false, false, 0.0);

        GateResult result = evaluator.evaluate(metrics, cfg);
    ...
    void forbiddenZonesFlagsPainAndUselessness() {
        ...
        GateConfig cfg = new GateConfig(false, 0.0, true, false, 0.0);
    ...
    void maxAverageDistanceFlagsProjectWide() {
        ...
        GateConfig cfg = new GateConfig(false, 0.0, false, true, 0.5);
    ...
    void passesWhenAllPackagesWithinThresholds() {
        Map<String, PackageMetrics> metrics = map(
                pkg("a", 0.4, 0.6, 0.0),
                pkg("b", 0.6, 0.4, 0.0));
        GateConfig cfg = new GateConfig(true, 0.7, true, true, 0.5);
